...
function client_list {
	...
	.SYNOPSIS
		List all of the clients that are registered with the server

	.DESCRIPTION
		Although the Chef Web UI provides a method to show the registered clients, it can be useful
	...
	.EXAMPLE
		...
		Invoke-POSHKnife client list

		Will list out the clients

	#>

	Write-Log -Message " "
	Write-Log -EVentId PC_INFO_0031 -extra ("Listing", "Clients")
